...
namespace SmartCoffee
{
	...
	public class BingSpeechApi
	{
		...
		public static async Task<SpeechResult> SpeechToTextAsync()
		{
			return await Task.Run(() => SpeechToText());
		}

		public static SpeechResult SpeechToText()
		{
			AccessTokenInfo token;
			string headerValue;

			Authentication auth = new Authentication("smartcoffeeapp", "b079a0014389449dbf71c891cb65d4bd");
